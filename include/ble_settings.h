...
// SCAN PARAMERTERS
#define SCAN_INTERVAL 128 // 80 = 50ms, 128 = 80 ms - scan setting on the scan module
#define SCAN_WINDOW 128 // 80 = 50ms, 128 = 80 ms - scan setting on the scan module
#define SCAN_WINDOW_MAIN 80  //ms - scan setting in the main file
